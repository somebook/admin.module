...
Devise.setup do |config|
  ...
  config.mailer_sender = "noreply@somebook.net"
  ...
  # config.pepper = "82179a44b01a874cf2eeb4640f9a8627b166c6c5453f3f4a00837dc0b0b30a6bb0c4a023937a94c2a1944604d48ceebff5e2e17e50460bb39b5e72c91eadebc4"
  ...
  accs = Somebook::Application.config.social_app_accounts
  config.omniauth :google_oauth2,
    accs[:google_analytics][:id],
    accs[:google_analytics][:secret],
    scope: accs[:google_analytics][:scope],
    name: :google_analytics

  config.omniauth :facebook,
    accs[:facebook][:app_id],
    accs[:facebook][:app_secret],
    scope: accs[:facebook][:scope]

  config.omniauth :twitter,
    accs[:twitter][:consumer_key],
    accs[:twitter][:consumer_secret]

  config.omniauth :vkontakte,
    accs[:vkontakte][:app_id],
    accs[:vkontakte][:app_secret],
    scope: accs[:vkontakte][:scope]

  config.omniauth :odnoklassniki,
    accs[:odnoklassniki][:app_id],
    accs[:odnoklassniki][:app_secret],
    scope: accs[:odnoklassniki][:scope]
